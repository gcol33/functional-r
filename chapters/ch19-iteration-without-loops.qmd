...
In @sec-column-wise, you saw `across()` for applying a function to multiple columns inside a dplyr verb. Now you can see what it really is: `map()` thinking applied inside a pipeline.
