...
The mechanism behind all of this is promises. Once you see how they work, non-standard evaluation, data masking, and `{{ }}` follow as consequences. Full metaprogramming lives in @sec-metaprogramming; here, the goal is understanding the machinery well enough to use it, and well enough to know when it's working against you.
