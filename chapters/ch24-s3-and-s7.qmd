...
Dispatch is just R picking *which* function to call, the same principle as "everything that happens is a function call" (@sec-operators-are-functions).
...
For S3, the answer is: almost none, and the programmer decides. It requires no registration, no formal definitions, and no boilerplate. You can add methods to existing generics from any package: write `print.my_class` in your package and it just works. You can prototype quickly: slap a class on a list and start writing methods.
