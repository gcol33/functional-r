...
Watch `total`. It starts at 0, becomes 3, becomes 8, becomes 10, becomes 18. The variable *varies*; the answer lives in its final state. This pattern, mutating a variable step by step until the answer appears, became the dominant way to think about computation itself.
