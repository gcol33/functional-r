...
Any function that takes a single argument works here. `abs` computes absolute values. `nchar` counts characters. You can pass any of them to `sapply` the same way --- but what exactly is `sapply` doing with the function you hand it?
