...
In @sec-calling-functions, you saw that typing `sqrt` without parentheses prints the function itself. That's because a function is a value, the same kind of thing as a number or a string. You can assign it, put it in a list, or check its type:
...
This section is just a first look. Scope, environments, and closures get a full treatment in @sec-closures-and-scope. For now, the practical rule is that what happens inside a function stays inside the function.
